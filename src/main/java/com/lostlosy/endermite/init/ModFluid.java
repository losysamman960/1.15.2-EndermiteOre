...
public class ModFluid {
    ...
    public static final ForgeFlowingFluid.Properties ENDERMITE_PROPERTIES = new ForgeFlowingFluid.Properties(
        ...
        //Fluid Block
    public static final RegistryObject<FlowingFluidBlock> ENDERMITE_BLOCK = ModBlocks.BLOCKS.register("endermite",
            () -> new FlowingFluidBlock(() -> ModFluid.ENDERMITE_FLUID.get(), Block.Properties.create(Material.WATER)
